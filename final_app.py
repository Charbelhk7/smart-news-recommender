...
if submitted:
    ...
    for i, row in videos_df.iterrows():
        ...
        if user_clean['tone']:
            matched_tones = [val for val in user_original['tone'] if val in row['tone']]
            if matched_tones:
                match_count += 1
        ...
        if user_clean['style']:
            matched_styles = [val for val in user_original['style'] if val in row['style']]
            if matched_styles:
                match_count += 1
        ...
        if user_clean['emotion']:
            matched_emotions = [val for val in user_original['emotion'] if val in row['emotion']]
            if matched_emotions:
                match_count += 1
        ...
        if user_clean['category']:
            matched_topics = [val for val in user_original['category'] if val in row['category']]
            if matched_topics:
                match_count += 1
